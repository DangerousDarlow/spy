...
export const double = <ThrowOnError extends boolean = false>(options: Options<DoubleData, ThrowOnError>) => (options.client ?? client).post<DoubleResponses, unknown, ThrowOnError>({
    url: '/Double',
    ...options,
    headers: {
        'Content-Type': 'application/json',
